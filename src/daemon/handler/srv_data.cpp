 ...
 */
hg_return_t
rpc_srv_proxy_write(hg_handle_t handle) {
    /*
     * 1. Setup
     */
 ...
 */
hg_return_t
rpc_srv_proxy_read(hg_handle_t handle) {
    /*
     * 1. Setup
     */
    // TODO Proxy write does not support the chunk bitmap yet
...
DEFINE_MARGO_RPC_HANDLER(rpc_srv_proxy_write)

DEFINE_MARGO_RPC_HANDLER(rpc_srv_proxy_read)
