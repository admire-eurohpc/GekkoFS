...
main(int argc, char* argv[]) {
    ...
    //    cout <<
    //    creat("/tmp/mountdir/#test-dir.0/mdtest_tree.0/file.mdtest.0000000.0000000005",
    //    0666) << endl; cout << stat("/tmp/mountdir/creat.txt", &attr) << endl;
    ...
    for(int i = 0; i < filen; ++i) {
        string p = "/dev/shm/vef_gkfs_mountdir/file" + to_string(i);
